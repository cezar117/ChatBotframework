...
<label class="white-text" data-producto="hotel" id="producto">Hoteles</label>
            ...
            <div class="form-line">
                ...
                <div class="">
                    <div class="input-field">
                        <div class="">
                            <span class="white-text">Destino</span></div>
                        <div class="">
                ...
                <div class="">
                    <div class="">
                        <span class="white-text">Habitaciones</span></div>
                    <div class="">
                ...
                <div class="habitaciones">
                    ...
                    <div class="col s12 @if($from === 'resultados') m12 l4 @else m3 @endif">
                        <div class=""><span class="white-text" for="adultos" >Adultos +18</span></div>
                        <div class="">
                    ...
                    <div class="col s12 @if($from === 'resultados') m12 l4 @else m3 @endif">
                        <div class=""><span class="white-text">Niños(-18)</span></div>
                        <div class="">
                    ...
                    <div class="divHabitaciones divHabitacion{{ $key+1 }} col s12 m12"><fieldset><legend>Habitacion {{ $key+1 }}</legend>
                            <div class="">
                                <div class="">
                                    <span class="white-text" for="adultos" >Adultos +18</span>
                                </div>
                                <div class=""><select id="adultos[]" class="browser-default form-control" name="adultos[]">
                            ...
                            <div class="">
                                <div class="">
                                    <span class="white-text">Niños(-18)</span>
                                </div><div class="">
                            ...
                            <div class="edadesMenoresH">

                                <div class="edadesMenores{{$key+1}}">
                                    @foreach($busqueda["edadMenores"][$key] as $key2=>$edad)
                                    <div id="divM{{ $key+($key2+1) }}" class="col s3 m6 l3">
                                        <div class="" style="margin-bottom: 10px;">
                                            <span class="white-text">Menor {{ ($key2+1) }}</span>
                                        </div>
                ...
                <div class="col s12 @if($from === 'resultados') m6 @else m6 l3 @endif ">
                        <div class=""><span class="white-text active" for="checkIn" >CheckIn</span></div>
                    ...
                    <div class="col s12 @if($from === 'resultados') m6 @else m6 l3 @endif">
                        <div class=""><span class="white-text active" for="checkOut" >CheckOut</span></div>
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-addon"><i class="material-icons prefix teal-text">today</i></div>
...
<div class="center">
    ...
    <button class="waves-effect waves-light btn" onclick="javascript:Busqueda2($(this));">buscar</button>
