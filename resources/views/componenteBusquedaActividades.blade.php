<div class="form1 A" >
<label class="white-text" data-producto="actividad" id="producto">Actividades</label>
        ...
        <div class="form-group form-float">
            <div class="form-line">
                ...
                <div class="input-field col s6 @if($from === 'resultados') m6 @else m4 @endif">
                    <div ><span class="white-text" for="adultos" >Adultos +18</span></div>
                    <div >
                ...
                <div class="col s12 @if($from === 'resultados') m12 @else m8 @endif">
                    <div ><span for="fecha" class="white-text active">Fecha inicio</span></div>
